...
ChristeBassFigures = \figuremode {
  ...
  <9> <8>2
  <7 [_+]>2.
  \bo <[_+ \l]>2 <6 4>8 \bc <[5 _+]>
  r2.
  \bo <[6 5]>4 \bc <[5 _+]>2 %90
  r2.
  r4 <6 5> <_+>
  r2. %93 FINIS
}
...
LiberScriptusBassFigures = \figuremode {
  ...
  <7>2 <7!>
  r <5 4>4 <\l 3>
  \bo <[4]>8 \bc <[3]> <7 5>4 <6 5>8 <\l 4> <8 6>4
  r <7 5>2 <6 4>4
  <7 6> <\l [5]> <6 5> <6 4> %410
  <5 4> <\l [3]> <5 4> <\l _+>
  r1
  ...
  <7> <9>4 <8>
  <7> <6>8 <5> <_+>4. <[4+] 2>8
  <6 5>2 \bo <[9 \l]>8 <8> r \bc <[4 2]>
  <6 5>2 <5 4>4 <\l 3> %420
  r2 <6 5>
  r4 \bo <[6 \l]>8 <6 5> <4>4 <3>
  r1
  <6 4>4 \bc <[5 3]>2. %424 finis
}
...
JusteJudexBassFigures = \figuremode {
  ...
  r2.
  r %775
  \bo <[4 3]>2 \bassFigureExtendersOn <4 3>4 \bassFigureExtendersOff
  <9 4> \bc <[8 3]>2
  r2 <6 4>4
  <7->2 <6 4>4
  <5 3>2 <6- 4>4 %780
...
QuiMariamBassFigures = \figuremode {
  ...
  r4 <6-> %890
  r2
  <[5 _-]>4 \bassFigureExtendersOn \bo <[6] _->8 \bc <[5] _-> \bassFigureExtendersOff
  <4>8 <_+> <6>4
  r8 <[_-]> <6>4
  r2 %895
  r8 <_->4.
